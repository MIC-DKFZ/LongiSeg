...
from longiseg.experiment_planning.dataset_fingerprint.fingerprint_extractor_longi import DatasetFingerprintExtractorLongiSeg
        ...
        if not isfile(properties_file) or overwrite_existing:
            ...
            with multiprocessing.get_context("spawn").Pool(self.num_processes) as p:
                ...
                for patient, patient_scans in self.patients.items():
                    r.append(p.starmap_async(DatasetFingerprintExtractorLongiSegTrack.analyze_patient,
